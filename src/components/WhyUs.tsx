...
const reasons = [
  { icon: <Shield className="w-8 h-8" />, title: 'Safety Certified', description: 'All glass is tempered for safety compliance and durability' },
  { icon: <Award className="w-8 h-8" />, title: 'Lifetime Warranty', description: 'Lifetime warranty on hardware and installation workmanship' },
  { icon: <Clock className="w-8 h-8" />, title: 'Fast Installation', description: 'Professional installation completed in as little as one day' },
  { icon: <DollarSign className="w-8 h-8" />, title: 'Competitive Pricing', description: 'Free estimates with transparent, competitive pricing' },
  { icon: <CheckCircle className="w-8 h-8" />, title: 'Licensed & Insured', description: 'Fully licensed and insured for your peace of mind' },
  { icon: <Wrench className="w-8 h-8" />, title: 'Expert Craftsmanship', description: '10+ years of experience with meticulous attention to detail' },
];
